...
## Npm commands for local to start
...
- **1990s Neon Aesthetic**: Full retro styling with neon colors, glowing effects, and animated borders
- **Blizzard Colors**: Uses Blizzard Entertainment's signature blue, red, and gold color schemes
- **8 Pages**: 
  - Home (Introduction + Conclusion)
  - Online Gaming in the 1990s
  - Battle.net Launches
  - Social Worlds and Community Forums
  - The Culture of Hacks, Duping, and Exploitation
  - Economic and Industry Impacts
  - Legacy and Modernization
  - Games (Diablo, StarCraft, Warcraft II themed blocks)

The website runs in the /public directory
